...
using UnitTests_video7e8.Controllers;
using UnitTests_video7e8.Dto;
using UnitTests_video7e8.Interfaces;
using UnitTests_video7e8.Models;

namespace UnitTests_video7e8.Tests.Controller
{
    public class PokemonControllerTests
    {
        ...
        [Fact]
        public void PokemonController_CreatePokemon_RuturnOk()
        {
            //Arrange
            int ownerId = 1;
            int catId = 2;
